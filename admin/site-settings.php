...
$enable_custom_post = $config_data['enable_custom_post'] ?? false; // カスタム投稿の有効状態を取得
    ...
    <form id="settingsForm">
        ...
        <div class="settings-card" style="margin-top:20px;">
            ...
            <div class="form-group" style="margin-bottom:15px;">
                ...
                <?php if ($logo_image_path && file_exists(__DIR__ . '/../' . $logo_image_path)): ?>
                    <div class="image-preview-wrap"><img src="../<?php echo htmlspecialchars($logo_image_path, ENT_QUOTES, 'UTF-8'); ?>"></div>
                <?php endif; ?>
            ...
            <div class="form-group" style="margin-bottom:15px;">
                ...
                <?php if ($favicon_image_path && file_exists(__DIR__ . '/../' . $favicon_image_path)): ?>
                    <div class="image-preview-wrap"><img src="../<?php echo htmlspecialchars($favicon_image_path, ENT_QUOTES, 'UTF-8'); ?>"></div>
                <?php endif; ?>
        ...
        <div class="settings-card" style="margin-top:20px;">
            ...
            <div class="form-group" style="margin-bottom:15px;">
                ...
                <p class="description">有効にすると、サイドバーにカスタム投稿タイプの管理メニューが追加されます。</p>
            </div>
        </div>
